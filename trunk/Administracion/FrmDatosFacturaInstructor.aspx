<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="~/Administracion/FrmDatosFacturaInstructor.aspx.cs" Inherits="FrmDatosFacturaInstructor" MaintainScrollPositionOnPostback="true"%>
...
<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
		...
		<tbody>
            ...
            <tr>
                ...
                <td style="width: 20px"><a href="FrmModificarFacturaInstructor.aspx?idfactura=<%=f.IdFactura%>&idInstructor=<%=lblIdParticipante.Text %>"><img  src="../Styles/images/editLog.png"/></a></td>
				<td style="width: 20px"><a href="FrmEliminarFacturasInstructor.aspx?idfactura=<%=f.IdFactura%>&idInstructor=<%=lblIdParticipante.Text %>"><img src="../Styles/images/delete.png" /></a></td>
