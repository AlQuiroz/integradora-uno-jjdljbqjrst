<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="FrmEliminarFacturasInstructor.aspx.cs" Inherits="FrmEliminarFacturasInstructor" MaintainScrollPositionOnPostback="true"%>
    ...
    <table style="width: 50%;">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Label ID="lblIdFactura" runat="server" Text="Label" Visible="False"></asp:Label>
            </td>
