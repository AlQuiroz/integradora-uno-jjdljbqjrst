...
&nbsp;<select name="edocivil" id="edocivil" runat="server" clientidmode="Static" style="font-family:Verdana;font-size:8pt;">
    ...
    <tr>
        ...
        <td align="left">
            ...
            <asp:TextBox ID="txtEdad" runat="server" Width="79px" ClientIDMode="Static"></asp:TextBox>
             <br />
...
<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
		...
		<tbody>
            ...
            <tr>
                ...
                <td style="width: 75px"><a href="mailto:#"></a></td>
                <th style="font-size: large;width:10px"><h3>  <a href="FrmModificarParticipante.aspx?idParticipante="><img src="../Styles/images/editLog.png"/></a></h3></th>
                <th style="font-size: large;width:10px"><h3><a href="FrmEliminarParticipante.aspx?idParticipante="><img src="../Styles/images/delete.png" /></a></h3></th>
                <th style="font-size: large; width:10px" ><h3><a href="FrmDatosFacturaParticipante.aspx?idParticipante=">
                    <img src="../Styles/images/factura.png" style="height: 20px; width: 24px" /></a></h3></th>
                <th style="font-size: large; width:10px" ><h3><a href="FrmDatosFacturaParticipante.aspx?idParticipante=">
                Grado de estudios</a></h3></th>

                <td style="visibility:visible; width: 2px;"></td>
